...
namespace Nalog
{
    public partial class DeyatForm : Form
    {
        ...
        private void LoadData()
        {
            ...
            dataAdapter = new SqlDataAdapter(" SELECT idDeyat, NameDeyat as 'Название деятельности' FROM deyaturlic", dataBaseConnection);
            dataAdapter.Fill(ds, "deyaturlic");
            DT = ds.Tables["deyaturlic"];
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand createUser = new SqlCommand("INSERT INTO deyaturlic (NameDeyat)VALUES(@NameDeyat)", sqlConnection);
                sqlConnection.Open();
                createUser.Parameters.AddWithValue("NameDeyat", NameBox.Text);
                try
                {
        ...
        {
            string sql = "UPDATE deyaturlic SET NameDeyat='" + MainTable[1, MainTable.SelectedCells[0].RowIndex].Value.ToString()
                 + "' WHERE idDeyat='" + MainTable[0, MainTable.SelectedCells[0].RowIndex].Value.ToString() + "'"; ;
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string commTextt = "delete from deyaturlic where idDeyat = @idDeyat";
                myConnection.Open();
                ...
                commt.Parameters.AddWithValue("@idDeyat", MainTable[0, MainTable.CurrentRow.Index].Value);
                try
                {
